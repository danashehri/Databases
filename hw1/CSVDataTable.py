...
class CSVDataTable(BaseDataTable):
    ...
    def find_by_primary_key(self, key_fields, field_list=None):
        ...
        :return: None, or a dictionary containing the requested fields for the record identified
            by the key.
        """
        #_key_columns is the primary key column PlayerID
        #key_fields is the value of the column
        #key:value >>> column:key_fields
    ...
    def delete_by_key(self, key_fields):
        ...
        """
        counter = 0
        rows_found = find_by_primary_key(key_fields)
        ...
        return "Number of rows deleted = " + counter
    ...
    def delete_by_template(self, template):
        ...
        """
        counter = 0
        rows_found = find_by_template(template)
    ...
    def update_by_template(self, template, new_values):
        ...
        matches_found = find_by_template(template)
        for record in matches_found:
            #record[]
            counter = counter + 1
        return counter
